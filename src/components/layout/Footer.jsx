                            ...
                            <div className="col-md-2">
                                <div className="quick-links">
                                    ...
                                    <ul>
                                        ...
                                        <li><NavLink to="/"><LiaShoppingCartSolid />About</NavLink></li>
                                        <li><NavLink to="/"><LiaShoppingCartSolid /> Shop</NavLink></li>
                                        <li><NavLink to="/"><LiaShoppingCartSolid /> Contact</NavLink></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-2">
